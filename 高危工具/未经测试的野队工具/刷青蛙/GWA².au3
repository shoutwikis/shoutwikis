...
Func Attack($aAgent)
	...
	Return SendPacket(0xC, 0x20, $lAgentID, 0)
EndFunc   ;==>Attack
...
Func MoveMap($aMapID, $aRegion, $aDistrict, $aLanguage)
	Return SendPacket(0x18, 0xAB, $aMapID, $aRegion, $aDistrict, $aLanguage, 1)
EndFunc   ;==>MoveMap
...
Func CallAttack($aTarget)
	...
	Return SendPacket(0xC, 0x20, $lTargetID, 1)
EndFunc   ;==>CallAttack
...
Func ChangeSecondProfession($aProfession)
	Return SendPacket(0xC, 0x3B, GetMyID(), $aProfession)
