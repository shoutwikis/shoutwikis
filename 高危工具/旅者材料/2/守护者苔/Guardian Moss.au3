...
Global $Outpost = 219 ;Outpost: Boreas Seabed
Global $Area1 = 211 ;Area: Pongmei Valley
...
Func FastWayOut()
	...
	MoveTo(-23704.56, 148.76)
	MoveTo(-25716.65, 1799.44)
	Move(-26000, 2700)
...
;~ 	AdlibRegister("HeroBuff", 5000)
	...
	If $DeadOnTheRun = 0 Then AggroMoveToEx(22347.52, 1264.85)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(21750.77, 3966.87)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(21290.24, 2314.41)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(19587.92, 4421.82)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(18343.24, 1344.99)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(17625.67, -457.10)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(18356.55, -1360.23)
