...
GUICtrlCreateLabel("Sandblasted Lodestone", 15, 180-70-30, 280)
GUICtrlSetFont(-1, 15)
...
Func SellItemToMerchant()
	...
	$merchant = GetNearestNPCToCoords(-1283.90, -2963.51)
	RNDSLP(1000)
...
Func CanPickUp($aitem)
	...
	If $m = 1584 Then Return True	;Sandblasted Lodestone
	If $m <> 1584 Then Return False
