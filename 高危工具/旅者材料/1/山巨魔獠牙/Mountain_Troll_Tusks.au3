...
Global $Outpost = 20 ;Outpost: Droknar's Forge
Global $Area1 = 26 ;Area: Talus Chute
...
;	WaitMapLoading($Area1)
	...
	If $DeadOnTheRun = 0 Then AggroMoveToEx(7908, -15821)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(3377, -14907)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(2036, -14754)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(-1430, -15534)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(-3184, -17351)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(-4638, -16619)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(-5665, -15452)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(-6209, -14481)			
	If $DeadOnTheRun = 0 Then AggroMoveToEx(-8207, -13543)
