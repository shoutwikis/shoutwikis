...
While 1
	If $boolrun = true Then
		...
		EndIf
		If GetMapID() <> 219 Then ;Outpost: Boreas Seabed
...
Func VQ()
	...
	If $DeadOnTheRun = 0 Then MoveTo(22250, 1381)	
	If $DeadOnTheRun = 0 Then AggroMoveToEx(21639, 3467)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(22085, 5611)
	
	If $DeadOnTheRun = 0 Then AggroMoveToEx(19464, 4245)	
	If $DeadOnTheRun = 0 Then AggroMoveToEx(17907, -2217)	
	
	If $DeadOnTheRun = 0 Then MoveTo(14156, -2729)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(11258, 728)	
