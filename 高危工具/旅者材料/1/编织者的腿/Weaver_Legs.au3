...
While 1
	If $boolrun = true Then
		...
		EndIf
		If GetMapID() <> 640 Then ;Outpost: Rata Sum
...
;	WaitMapLoading(569)
	...
	If $DeadOnTheRun = 0 Then AggroMoveToEx(16887, 12030)	
	If $DeadOnTheRun = 0 Then AggroMoveToEx(17291, 7934)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(18658, 5603)	
	If $DeadOnTheRun = 0 Then AggroMoveToEx(18374, 2095)	
	If $DeadOnTheRun = 0 Then AggroMoveToEx(17200, -757)	
	If $DeadOnTheRun = 0 Then AggroMoveToEx(17293, -3146)
