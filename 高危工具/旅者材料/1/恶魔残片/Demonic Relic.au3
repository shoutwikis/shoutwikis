...
Global $Outpost = 469 ;Outpost: Gate of Fear
Global $Area1 = 469 ;Area: Haiju Lagoon
...
;	WaitMapLoading($Area1)
	...
	If $DeadOnTheRun = 0 Then AggroMoveToEx(9944, 6905)
	If $DeadOnTheRun = 0 Then AggroMoveToEx(11555, 9004)
