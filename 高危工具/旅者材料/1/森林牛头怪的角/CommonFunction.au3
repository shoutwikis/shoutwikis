...
GUICtrlCreateLabel("Forest Minotaur Horns", 15, 180-70-30, 280)
GUICtrlSetFont(-1, 15)
...
;GUICtrlCreateGroup("Status: Title", 275-265, 235-132-35, 150, 195-80-40)
;GUICtrlCreateLabel("Nicholas Item:", 285-265, 255-132-35, 27, 17)
;GUICtrlCreateLabel("Made:", 380-265, 255-132-35, 40, 17)
;GUICtrlCreateLabel("Asura", 285-265, 285-132-35-15, 70, 17)
...
Func CanPickUp($aitem)
	...
	If $m = 440 Then Return True	;440 = Forest Minotaur Horn
	If $m <> 440 Then Return False
