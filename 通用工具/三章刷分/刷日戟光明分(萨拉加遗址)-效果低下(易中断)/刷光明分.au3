...
Func CombatLoop()
	...
	RndSleep(3500)
	Local $enemy = "第一组不死生物"
	commandhero(1, -1950, 9871)
	commandhero(2, -1950, 9871)
	commandhero(3, -1950, 9871)
	commandhero(4, -1950, 9871)
	commandhero(5, -1950, 9871)
	commandhero(6, -1950, 9871)
	commandhero(7, -1950, 9871)
	MoveTo(-1950, 9871)
	useskill(5, -2)
	useheroskill(1,5)
	useheroskill(2,5)
	...
	commandhero(1, -4705, 11411)
	commandhero(2, -4705, 11411)
	commandhero(3, -4705, 11411)
	commandhero(4, -4705, 11411)
	commandhero(5, -4705, 11411)
	commandhero(6, -4705, 11411)
	commandhero(7, -4705, 11411)
	MoveTo(-4705, 11411)
	useskill(5, -2)
	useheroskill(1,5)
	useheroskill(2,5)
	...
	commandhero(1, -13839, 7961)
	commandhero(2, -13839, 7961)
	commandhero(3, -13839, 7961)
	commandhero(4, -13839, 7961)
	commandhero(5, -13839, 7961)
	commandhero(6, -13839, 7961)
	commandhero(7, -13839, 7961)
	MoveTo(-13839, 7961)
	useskill(5, -2)
	useheroskill(1,5)
	useheroskill(2,5)
	...
	commandhero(1, -19332, -9200)
	commandhero(2, -19332, -9200)
	commandhero(3, -19332, -9200)
	commandhero(4, -19332, -9200)
	commandhero(5, -19332, -9200)
	commandhero(6, -19332, -9200)
	commandhero(7, -19332, -9200)
	MoveTo(-19332, -9200)
	useskill(5, -2)
	useheroskill(1,5)
	useheroskill(2,5)
	...
	commandhero(1, -22748, -10570)
	commandhero(2, -22748, -10570)
	commandhero(3, -22748, -10570)
	commandhero(4, -22748, -10570)
	commandhero(5, -22748, -10570)
	commandhero(6, -22748, -10570)
	commandhero(7, -22748, -10570)
	MoveTo(-22748, -10570)
	useskill(5, -2)
	useheroskill(1,5)
	useheroskill(2,5)
