...
; 技能表
Global Const $SkillBarTemplate = "OgcTcVM+ZC5Qn5ACB6u84Q4A3BA"

; 技能表中位置
; ele lord is really fire attunement
Global Const $SQ = 1
Global Const $SF = 2
Global Const $SD = 3
Global Const $HOS = 4
...
; 部分集合
Global $Array_pscon[38]=[$ITEM_ID_HUNTERS_ALE, $ITEM_ID_DWARVEN_ALE, $ITEM_ID_SPIKED_EGGNOG, $ITEM_ID_EGGNOG, $ITEM_ID_SHAMROCK_ALE, $ITEM_ID_AGED_DWARVEN_ALE, $ITEM_ID_CIDER, _
...
$ITEM_ID_VICTORY_TOKEN, $ITEM_ID_WINTERSDAY_GIFT, $ITEM_ID_LUNAR_TOKEN, $ITEM_ID_LUNAR_TOKENS, $ITEM_ID_TOTS] ;missing $ITEM_ID_GLACIAL_STONES
