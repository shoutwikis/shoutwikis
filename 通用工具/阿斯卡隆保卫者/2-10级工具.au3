...
repeats. Credits to the GWA2 team (TheArkanaProject and miracle444), the GWCA team, bl4ck3lit3 and all those whose functions I am using.
...
$cGUI = GUICreate("2级-10级", 270, 280, 200, 180)
;$cbxigneous = GUICtrlCreateCheckbox("用召唤石", 8, 8, 110, 17)
$cbxHideGW = GUICtrlCreateCheckbox("停止成像", 135, 8, 110, 17)
$lblName = GUICtrlCreateLabel("角色名:", 8, 34, 80, 17, BitOR($SS_CENTER, $SS_CENTERIMAGE))
$txtName = GUICtrlCreateLabel($strName, 105, 34, 150, 20, $SS_CENTER)
$lblR2D2 = GUICtrlCreateLabel("总圈数:", 8, 60, 130, 17)
$lblRuns = GUICtrlCreateLabel("-", 140, 60, 100, 17, $SS_CENTER)
$lblCash = GUICtrlCreateLabel("随身现金值:", 8, 84, 130, 17)
$lblGold = GUICtrlCreateLabel($GOLD, 140, 84, 100, 17, $SS_CENTER)
$lblXP = GUICtrlCreateLabel("总经验值:", 8, 108, 130, 17)
$lblExperience = GUICtrlCreateLabel($EXP, 140, 108, 100, 17, $SS_CENTER)
$lblLvl = GUICtrlCreateLabel("角色等级:", 8, 128, 130, 17)
$lblLevel = GUICtrlCreateLabel($level, 140, 128, 100, 17, $SS_CENTER)
$statexpleft = GUICtrlCreateLabel("升级所需经验值:", 8, 148, 140, 17)
$lblexpleft = GUICtrlCreateLabel($experienceleft, 140, 148, 100, 17, $SS_CENTER)
$lvlbar = GUICtrlCreateProgress(8, 195, 256, 10)
$lblpercent = GUICtrlCreateLabel("百分比:" , 8, 176, 100, 17)
$percent = GUICtrlCreateLabel(Round($lvlprogbar,1) & "%", 144, 176, 100, 17, $SS_CENTER)
$lblStatus = GUICtrlCreateLabel("准备就绪", 8, 219, 256, 17, $SS_CENTER)
$btnStart = GUICtrlCreateButton("开始", 7, 242, 256, 25, $WS_GROUP)
...
WaitMapLoading(146) ;lakeside county
PingSleep(2000)
If $boolIgneous Then
